...
struct ItemStorage3: IItemStorage {
    ...
    private static let pouchItemsColo: [Int] = pouchItems + [537]
    // XD adds PokeSnack
    private static let pouchItemsXD: [Int] = pouchItems + [511]
    ...
    private static let keyItemsFRLG: [Int] = [349, 350, 351, 352, 353, 354, 355, 356, 357, 358, 359, 360, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374,
    ]
    private static let keyItemsE: [Int] = [375, 376]
    
    private static let pouchKeyFRLG: [Int] = pouchKey + keyItemsFRLG
    private static let pouchKeyE: [Int] = pouchKeyFRLG + keyItemsE
    
    private static let pouchKeyColo: [Int] = [
        500, 501, 502, 503, 504, 505, 506, 507, 508, 509, 510, 511, 512, 513, 514, 515, 516, 517, 518, 519,
        520, 521, 522, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532, 533, 534, 535, 536, 538, 539,
        540, 541, 542, 546, 547]
    
    private static let pouchKeyXD: [Int] = [
    ...
    private static let pouchHM: [Int] = [339, 340, 341, 342, 343, 344, 345, 346]
    ...
    private static let unreleased: [Int] = [005] // Safari Ball
    
    /* Colognes */
    private static let pouchCologneColo: [Int] = [543, 544, 545]
    private static let pouchCologneXD: [Int] = [513, 514, 515]
    
    /* Disks (XD only) */
    private static let pouchDiscXD: [Int] = [
