...
struct ItemStorage7: IItemStorage {
    private let version: GameVersion

    static let instanceSM = ItemStorage7(version: GameVersion.SM)
    ...
    private static let pouchItems: [Int] = [
        ...
        110, 111, 112, 116, 117, 118, 119, 135, 136, 137,
        ...
        680, 681, 682, 683, 684, 685, 699,
        704, 710, 711, 715,
        752, 753, 754, 755, 756, 757, 758, 759,
        760, 761, 762, 763, 764, 767, 768, 769,
        770, 795, 796,
        844, 846, 849, 851, 853, 854, 855, 856, 879,
        880, 881, 882, 883, 884,
    ...
    private static let baseHeldItems = pouchItems + pouchMedicine + pouchBerries
    static let allHeldItemsSM = baseHeldItems + pouchZCrystalsHeld
    static let allHeldItemsUSUM = baseHeldItems + pouchZCrystalsHeldUSUM

    func getCrystalHeld(itemKey: Int) -> Int {
    ...
    func getItems(type: InventoryType) -> [Int] {
        ...
        case .Items:
            return ItemStorage7.pouchItems
        case .TMHMs:
            return ItemStorage7.pouchTMHM
        case .Berries:
            return ItemStorage7.pouchBerries
        case .KeyItems:
            return if version == GameVersion.USUM {
                ItemStorage7.pouchKeyUSUM
            } else {
                ItemStorage7.pouchKey
            }
        case .ZCrystals:
            return if version == GameVersion.USUM {
                ItemStorage7.pouchZCrystalsUSUM
            } else {
                ItemStorage7.pouchZCrystals
            }
        case .BattleItems:
            return if version == GameVersion.USUM {
                ItemStorage7.pouchRotoUSUM
            } else {
                []
            }
        default:
    ...
    func isLegal(type: InventoryType, itemIndex: Int, itemCount: Int) -> Bool {
        if type == .KeyItems || type == .ZCrystals {
            return true
        }
