...
struct ItemStorage8SWSH: IItemStorage {
    ...
    private static let dynamaxStart = 1279, dynamaxEnd = 1578, dynamaxLegalEnd = 1290
    ...
    func isDynamaxCrystal(item: Int) -> Bool {
        return ItemStorage8SWSH.dynamaxRange.contains(item)
    }

    func isDynamaxCrystalAvailable(item: Int) -> Bool {
        return ItemStorage8SWSH.legalDynamaxRange.contains(item)
    }
    ...
    func getItems(type: InventoryType) -> [Int] {
        ...
        case .Balls:
            return ItemStorage8SWSH.pouchBall
        case .BattleItems:
            return ItemStorage8SWSH.pouchBattle
        case .Berries:
            return ItemStorage8SWSH.pouchBerries
        case .Items:
            return ItemStorage8SWSH.pouchItems
        case .TMHMs:
            return ItemStorage8SWSH.pouchTMTR
        case .Treasure:
            return ItemStorage8SWSH.pouchTreasure
        case .Candy:
            return ItemStorage8SWSH.pouchIngredients
        case .KeyItems:
            return ItemStorage8SWSH.pouchKey
        default:
            return []
        }
    }
