...
struct ItemStorage7GG: IItemStorage {
    ...
    private static let pouchRegular: [Int] = [
        ...
        442, 571, 632, 651, 795, 796,
        872, 873, 874, 875, 876, 877, 878, 885, 886, 887, 888, 889, 890, 891, 892, 893, 894, 895, 896,
        900, 901, 902,
    ]
    ...
    func getItems(type: InventoryType) -> [Int] {
        ...
        case .TMHMs:
            return ItemStorage7GG.pouchTMHM
        case .Balls:
            return ItemStorage7GG.pouchCatching
        case .Items:
            return ItemStorage7GG.pouchRegular
        case .BattleItems:
            return ItemStorage7GG.pouchBattle
        case .ZCrystals:
            return ItemStorage7GG.pouchPowerUp
        case .Candy:
            return ItemStorage7GG.pouchCandy
        default:
            return []
        }
    }
