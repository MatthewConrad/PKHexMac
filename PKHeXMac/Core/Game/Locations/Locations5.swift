...
//  PKHeXMac
//
//  Created by Matthew Conrad on 2/12/24.
//

import Foundation


/// Locations for `GameVersion.Gen5`
struct Locations5
{
    /// Available location list for the 00000 set of location names.
    static let Met0: [Int] = [
        -1,  001, 002, -1,  004, 005, 006, 007, 008, 009,
    ...
    static let Met3: [Int] = [
        -1,    30001, 30002, -1,     30004, 30005, 30006, 30007, 30008,
         30010, 30011, 30012, 30013, 30014, 30015,
    ];
    
    /// Available location list for the 40000 set of location names.
    static let Met4: [Int] = [
        40001, 40002, 40003, 40004, 40005, 40006, 40007, 40008, 40009, -1,
    ...
    static let Met6: [Int] = [60001, 60003];
}
